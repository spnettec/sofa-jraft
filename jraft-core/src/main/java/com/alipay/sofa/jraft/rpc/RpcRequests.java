...
public final class RpcRequests {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              com.alipay.sofa.jraft.entity.EnumOutter.ReadOnlyType value = com.alipay.sofa.jraft.entity.EnumOutter.ReadOnlyType.valueOf(rawValue);
              if (value == null) {
    ...
    @java.lang.Override public com.alipay.sofa.jraft.entity.EnumOutter.ReadOnlyType getReadOnlyOptions() {
      @SuppressWarnings("deprecation")
      com.alipay.sofa.jraft.entity.EnumOutter.ReadOnlyType result = com.alipay.sofa.jraft.entity.EnumOutter.ReadOnlyType.valueOf(readOnlyOptions_);
